...
export default function DetailOrder({
    ...
    const getOrderById = async () => {
        if (!orderId) return;
        const response = await axios.get(`https://cozastore.tryasp.net/api/Order/${orderId}`);
    ...
    const exportOrder = async () => {
        try {
            const response = await axios.get(`https://cozastore.tryasp.net/api/Order/export-file/${orderId}`);
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="products">
                                                <img src={`https://cozastore.tryasp.net/${item.product?.medias[0]?.link}`} alt="hình ảnh" />
