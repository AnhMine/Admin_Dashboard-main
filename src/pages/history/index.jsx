...
export default function History() {
  ...
  const fetchHistoryData = async () => {
    try {
      const response = await axios.get(`https://cozastore.tryasp.net/api/Login/get-all-login?maxPageSize=${totalCount}&PageSize=${rowsPerPage}&PageNumber=${page + 1}`); // Replace with your actual API URL
